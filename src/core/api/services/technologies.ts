...
export const addTechnology = (payload: AddTechnologyPayload) => core.post<{ id: number }>(ADD_TECHNOLOGY, toFormData(payload), {
  headers: { 'Content-Type': 'multipart/form-data' },
});

export const editTechnology = (id: number, payload: EditTechnologyPayload) => core.put<{ id: number }>(`${EDIT_TECHNOLOGY}/${id}`, toFormData(payload), {
  headers: { 'Content-Type': 'multipart/form-data' },
});
