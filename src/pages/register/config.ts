...
export const REGISTER_STEPS: RegisterStep[] = [
  ...
  },
  {
    ...
    subTitle: 'Say something about yourself',
    path:
  ...
  {
    title: 'Work & Company',
    subTitle: 'Will be used for notifications and searching purposes',
    path:
  ...
  {
    title: 'Policy & Confirmations',
    subTitle: 'Read our policy and confirm account creation',
    path: 'M28.8 12L28 8H10v34h4V28h11.2l.8 4h14V12z',
    formConfig: null
  }
];
